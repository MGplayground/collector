/**
 * Analytics arithmetic, with no data access.
 *
 * This lives in the domain layer rather than beside the fetcher because
 * `services/` imports the Supabase client at module load, which needs
 * environment variables. A pure computation should not need a configured
